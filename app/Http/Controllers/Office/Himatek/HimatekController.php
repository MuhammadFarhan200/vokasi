...
namespace App\Http\Controllers\Office\Himatek;
...
class HimatekController extends Controller
{
    public function index(Request $request)
    {
        if($request->ajax())
        {
            $collection = Activity::where('category', 'himatek')->paginate(10);
            return view('pages.app.himatek.activity.list',compact('collection'));
        }
        return view('pages.app.himatek.activity.main');
    }

    public function create()
    {
        return view('pages.app.himatek.activity.input', ['data' => new Activity]);
    }
    ...
    {
        return view('pages.app.himatek.activity.input', ['data' => $activity]);
    }
