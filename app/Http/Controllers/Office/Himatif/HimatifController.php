...
namespace App\Http\Controllers\Office\Himatif;
...
class HimatifController extends Controller
{
    public function index(Request $request)
    {
        if($request->ajax())
        {
            $collection = Activity::where('category', 'himatif')->paginate(10);
            return view('pages.app.himatif.activity.list',compact('collection'));
        }
        return view('pages.app.himatif.activity.main');
    }

    public function create()
    {
        return view('pages.app.himatif.activity.input', ['data' => new Activity]);
    }
    ...
    {
        return view('pages.app.himatif.activity.input', ['data' => $activity]);
    }
