    ...
    <div id="header-wrap">
        <div class="container-fluild">
            <div class="header-row">
                ...
                ============================================= -->
                <div id="logo">
                    <div style="height: 60px !important" class="ms-4">
                        <a href="{{route('web.home')}}">
                            <img class="logo-default" style="height: 60px !important" srcset="{{ $logo_thumbnail ?? asset('web/images/logodel.png') }}, {{ $logo_thumbnail ?? asset('web/images/logodel.png') }}" src="{{ $logo_thumbnail ?? asset('web/images/logodel.png') }}" alt="Canvas Logo">
                            <img class="logo-dark" style="height: 60px !important" srcset="{{ $logo_thumbnail ?? asset('web/images/logodel.png') }}, {{ $logo_thumbnail ?? asset('web/images/logodel.png') }}" src="{{ $logo_thumbnail ?? asset('web/images/logodel.png') }}" alt="Canvas Logo">
                        </a>
                    </div>
                    <a href="{{ route('web.home') }}" class="ms-3 my-4" style="margin-right:-90px;">
