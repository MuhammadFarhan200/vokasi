<x-app-layout title="KA Prodi Dasbor">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-800">KA Prodi</li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="card bg-info bg-opacity-75 text-white">
                                <div class="card-body fw-semibold">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ route('office.kaprodi.index') }}" class="menu-link ms-auto text-white text-decoration-underline">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 col-lg-10">
                            <div class="card border border-gray-500 border-1">
                                ...
                                <div class="card-body">
                                    <h5 class="fw-semibold">Pada Halaman ini KA Prodi Dapat Melakukan:</h4>
                                    <ol class="fw-semibold">
                                        <li>Melihat data FRK dan FED yang disubmit oleh dosen fakultas</li>
