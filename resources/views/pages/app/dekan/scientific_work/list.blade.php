    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="text-end text-nowrap">
                ...
                <a href="{{ route('office.dekan.scientific-work.edit', $item->id) }}" class="menu-link btn btn-sm btn-primary text-nowrap">
        ...
        @include('pages.app.dekan.scientific_work.show')
        @endforeach
    </tbody>
</table>
{{$sf->links('themes.app.dekan_pagination.pagination_sf')}}
