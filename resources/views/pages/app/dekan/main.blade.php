        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5">
                ...
                <div class="card-body pt-0">
                    <div id="list_teaching_dekan" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_fpa_dekan" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_fpt_dekan" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_sf_dekan" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_research_dekan" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_rd_dekan" class="table-responsive"></div>
                </div>
            </div>
        </div>
    </div>
