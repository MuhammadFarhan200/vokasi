    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="text-end text-nowrap">
                ...
                <a href="{{ route('office.dekan.fpt.edit', $item->id) }}" class="menu-link btn btn-sm btn-primary text-nowrap">
        ...
        @include('pages.app.dekan.fpt.show')
        @endforeach
    </tbody>
</table>
{{$fpt->links('themes.app.dekan_pagination.pagination_fpt')}}
