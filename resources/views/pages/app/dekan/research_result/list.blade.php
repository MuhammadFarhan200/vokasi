    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="text-end text-nowrap">
                ...
                <a href="{{ route('office.dekan.research-result.edit', $item->id) }}" class="menu-link btn btn-sm btn-primary text-nowrap">
        ...
        @include('pages.app.dekan.research_result.show')
        @endforeach
    </tbody>
</table>
{{$research->links('themes.app.dekan_pagination.pagination_research')}}
