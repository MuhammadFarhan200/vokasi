    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="">
                ...
                <a href="{{ Storage::url($item->assignment_proof) }}" target="_blank" class="menu-link text-primary fw-semibold text-nowrap">
                    <i class="fa-solid fa-eye text-primary"></i>
                    Lihat Bukti Penugasan
                </a>
                <span class="badge badge-success d-block mt-2"><i class="bi bi-check text-white me-1"></i>Dilengkapi Bukti Penugasan</span>
                @else
                <span class="badge badge-danger d-block mt-2">Bukti Penugasan Belum Diupload</span>
                @endif
            </td>
            <td>{{ $item->status }}</td>
            ...
            <td class="text-end text-nowrap">
                ...
                <a href="{{ route('office.dekan.result-dev.edit', $item->id) }}" class="menu-link btn btn-sm btn-primary text-nowrap">
        ...
        @include('pages.app.dekan.result_dev.show')
        @endforeach
    </tbody>
</table>
{{$rd->links('themes.app.dekan_pagination.pagination_rd')}}
