    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="text-end text-nowrap">
                <button data-bs-toggle="modal" data-bs-target="#fpa-{{ $item->id }}" class="menu-link btn btn-sm btn-primary text-nowrap">
        ...
        @include('pages.app.kaprodi.fpa.show')
        @endforeach
    </tbody>
</table>
{{$fpa->links('themes.app.kaprodi_pagination.pagination_fpa')}}
