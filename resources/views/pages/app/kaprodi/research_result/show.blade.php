<div class="modal fade" tabindex="-1" id="research-{{ $item->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detail Data Hasil Penelitian</h4>
            ...
            <div class="modal-body fw-semibold">
                ...
                <div class="d-flex justify-content-between">
                    <p>Tanggal Terbit</p>
                    <p>{{ $item->published ? date('d M Y', strtotime($item->published)) : '-' }}</p>
                </div>
                <div class="d-flex justify-content-between">
                    @php
                        $status = $item->status ?? '-';
