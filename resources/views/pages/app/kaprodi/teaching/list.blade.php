    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="text-end text-nowrap">
                <button data-bs-toggle="modal" data-bs-target="#teaching-{{ $item->id }}" class="menu-link btn btn-sm btn-primary text-nowrap">
        ...
        @include('pages.app.kaprodi.teaching.show')
        @endforeach
    </tbody>
</table>
{{$teaching->links('themes.app.kaprodi_pagination.pagination_teaching')}}
