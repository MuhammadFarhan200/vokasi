    ...
    <tbody class="fw-semibold text-gray-600">
        ...
        <tr>
            ...
            <td class="text-end text-nowrap">
                ...
                @endif --}}
                <button type="button" title="Hapus" id="tombol_hapus" data-redirect-url="{{route('office.about.vision.index')}}" onclick="handle_confirm('DELETE','{{route('office.about.vision.destroy',$item->id)}}','#tombol_hapus');" class="btn btn-icon btn-danger"><i class="las la-trash fs-2"></i></button>
            </td>
        </tr>
        @endforeach
    </tbody>
