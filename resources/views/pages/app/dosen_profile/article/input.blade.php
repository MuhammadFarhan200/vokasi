<x-app-layout title="{{$data->id ? 'Perbarui' : 'Tambah'}} Artikel">
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 transition-fade">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Artikel</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-800">Artikel</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-800 w-5px h-2px"></span>
                    </li>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.dosen.artikel.index')}}" action="{{$data->id ? route('office.dosen.artikel.update', $data->id) : route('office.dosen.artikel.store')}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                            <input type="hidden" name="user_id" id="user_id" value="{{ $dosen->id }}">
                            <div class="col-12">
                                <label class="required fw-semibold fs-6 mb-2">Judul Artikel</label>
                                <input type="text" class="form-control form-control-solid mb-3" name="title" id="title" value="{{$data->title}}">
                            </div>
                            <div class="col-6">
                                <label class="required fw-semibold fs-6 mb-2">Waktu publikasi</label>
                                <input type="date" class="form-control form-control-solid number_only mb-3" name="date" id="year" value="{{$data->date}}">
                            </div>
                            <div class="col-6">
                                <label class="required fw-semibold fs-6 mb-2">Tempat Penerbitan</label>
                        ...
                        <div class="text-center pt-15">
                            <a href="{{route('office.dosen.artikel.index')}}" class="menu-link btn btn-light me-3">Batal</a>
