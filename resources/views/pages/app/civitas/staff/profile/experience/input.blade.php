<x-app-layout title="Pengalaman">
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 transition-fade">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Pengalaman</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-800">Pengalaman</li>
                </ul>
            </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.civitas.staff.experience.index', $staff->id)}}" action="{{$data->id ? route('office.civitas.staff.experience.update', $data->id) : route('office.civitas.staff.experience.store')}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                        ...
                        <div class="text-center pt-15">
                            <a href="{{route('office.civitas.staff.experience.index', $staff->id)}}" class="menu-link btn btn-light me-3">Batal</a>
