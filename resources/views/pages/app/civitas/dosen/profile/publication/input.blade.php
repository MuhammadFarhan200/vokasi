<x-app-layout title="{{$data->id ? 'Perbarui' : 'Tambah'}} Publikasi">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-800">Publikasi Teratas</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-800 w-5px h-2px"></span>
                    </li>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.civitas.dosen.publication.index', $dosen->id)}}" action="{{$data->id ? route('office.civitas.dosen.publication.update', $data->id) : route('office.civitas.dosen.publication.store', $dosen->id)}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                        ...
                        <div class="text-center pt-15">
                            <a href="{{route('office.civitas.dosen.publication.index', $dosen->id)}}" class="menu-link btn btn-light me-3">Batal</a>
