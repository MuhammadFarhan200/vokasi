<x-app-layout title="{{$data->id ? 'Perbarui' : 'Tambah'}} Gugus Bidang Kajian">
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 transition-fade">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Gugus Bidang Kajian</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-800">Gugus Bidang Kajian</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-800 w-5px h-2px"></span>
                    </li>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.civitas.dosen.studies.index', $dosen->id)}}" action="{{$data->id ? route('office.civitas.dosen.studies.update', $data->id) : route('office.civitas.dosen.studies.store', $dosen->id)}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-solid mb-3" name="code" id="code" value="{{$data->code}}">
                            </div>
                            <div class="col-md-8">
                                <label class="required fw-semibold fs-6 mb-2">Gugus Bidang Kajian</label>
                                <input type="text" class="form-control form-control-solid mb-3" name="name" id="name" value="{{$data->name}}">
                            </div>
                        </div>
                        <div class="text-center pt-15">
                            <a href="{{route('office.civitas.dosen.studies.index', $dosen->id)}}" class="menu-link btn btn-light me-3">Batal</a>
