<x-app-layout title="Gugus Bidang Kajian">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ route('office.civitas.dosen.studies.create', $dosen->id) }}" class="menu-link btn btn-primary">Tambah Gugus Bidang Kajian</a>
                        </div>
                    </div>
                </div>
