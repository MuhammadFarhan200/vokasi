<x-app-layout title="Identitas">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.civitas.dosen.index')}}" action="{{ route('office.civitas.dosen.personal.update',$data->id) }}" method="PATCH">
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-6">
                                <label class="fw-semibold fs-6 mb-2">Link Website Pribadi</label>
                            ...
                            <div class="col-md-6">
                                <label class="d-block fw-semibold fs-6 mb-2">Avatar</label>
                                <img
