<x-app-layout title="{{$data->id ? 'Perbarui' : 'Tambah'}} Artikel">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.civitas.dosen.article.index', $dosen->id)}}" action="{{$data->id ? route('office.civitas.dosen.article.update', $data->id) : route('office.civitas.dosen.article.store', $dosen->id)}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                        ...
                        <div class="text-center pt-15">
                            <a href="{{route('office.civitas.dosen.article.index', $dosen->id)}}" class="menu-link btn btn-light me-3">Batal</a>
