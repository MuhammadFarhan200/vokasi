<div class="modal fade" tabindex="-1" id="clp-{{ $item->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detail Data Menduduki Jabatan Pimpinan Perguruan Tinggi</h4>
            ...
            <div class="modal-body fw-semibold">
                ...
                <div class="d-flex justify-content-between">
                    <p>Harapan Waktu Menjabat</p>
                    <p>{{ $item->expectation_time ?? '-' }}</p>
                </div>
                <div class="d-flex justify-content-between">
                    <p>SKS</p>
                    <p>{{ $item->sks ?? '-' }}</p>
