<div class="modal fade" tabindex="-1" id="fpt-{{ $item->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detail Data Penguji</h4>
            ...
            <div class="modal-body fw-semibold">
                ...
                <div class="d-flex justify-content-between">
                    <p>Komponen yang Diuji</p>
                    <p>{{ $item->testedComponent->name ?? '-' }}</p>
                </div>
                <div class="d-flex justify-content-between">
                    <p>Posisi Penguji</p>
                    <p>{{ $item->testerPosition->name ?? '-' }}</p>
                </div>
                <div class="d-flex justify-content-between">
                    <p>Judul Kelompok Pengujian</p>
