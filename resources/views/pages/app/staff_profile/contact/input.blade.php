<x-app-layout title="Edit Kontak">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.dashboard.index')}}" action="{{$data->id ? route('office.staff.contact.update', $data->id) : route('office.staff.contact.store')}}" method="{{$data->id ? 'PATCH' : 'POST'}}">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                            <div class="col-md-4">
