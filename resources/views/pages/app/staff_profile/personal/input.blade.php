<x-app-layout title="Identitas">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.dashboard.index')}}" action="{{ route('office.staff.identitas.update') }}" method="PATCH">
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="position" id="staf_position" class="form-select form-select-solid">
