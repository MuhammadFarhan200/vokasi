                    ...
                    <div class="card-body">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-solid mb-3" name="location" id="location" value="{{ $data->location }}">
                            </div>
                            <div class="col-md-6">
                                <label class="required fw-semibold fs-6 mb-2">Bukti Penugasan</label>
