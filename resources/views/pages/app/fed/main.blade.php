        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5">
                ...
                <div class="card-body pt-0">
                    <div id="list_teaching" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_fpa" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_fpt" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_sf" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_research" class="table-responsive"></div>
                </div>
            </div>
            <div class="card mb-5">
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <div id="list_rd" class="table-responsive"></div>
                </div>
            </div>
        </div>
    </div>
