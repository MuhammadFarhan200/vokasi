                    ...
                    <div class="card-body">
                        <div class="row mb-10">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control form-control-solid mb-3" value="{{ $data->name }}" readonly>
                            </div>
                            <div class="col-lg-4">
                                <label class="required fw-semibold fs-6 mb-2">Nama Jurnal</label>
                                <input type="text" class="form-control form-control-solid mb-3" value="{{ $data->journal_name }}" readonly>
                            </div>
                            <div class="col-lg-4">
                                <label class="required fw-semibold fs-6 mb-2">Tanggal Terbit</label>
                                <input type="date" class="form-control form-control-solid mb-3" value="{{ $data->published }}" readonly>
                            </div>
