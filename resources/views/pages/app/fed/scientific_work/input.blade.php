<x-app-layout title="Karya Ilmiah">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-gray-800">Karya Ilmiah</li>
                </ul>
            </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid transition-fade">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="form_input" class="form" data-redirect-url="{{route('office.fed.index')}}" action="{{ route('office.fed.scientific-work.update',$data->id) }}" method="PATCH">
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row mb-10">
                            <div class="col-lg-4">
                                <label class="required fw-semibold fs-6 mb-2">Nama Kegiatan</label>
                                <input type="text" class="form-control form-control-solid mb-3" name="activity_name1" id="activity_name1" value="{{ $data->name }}">
                            </div>
                            <div class="col-lg-4">
                                <label class="required fw-semibold fs-6 mb-2">Nama Jurnal</label>
                                <input type="text" class="form-control form-control-solid mb-3" name="journal_name" id="journal_name" value="{{ $data->journal_name }}">
                            </div>
                            <div class="col-lg-4">
                                <label class="required fw-semibold fs-6 mb-2">Tanggal Terbit</label>
                                <input type="date" class="form-control form-control-solid mb-3" name="published1" id="published1" value="{{ $data->published }}">
                            </div>
                            <div class="col-md-6">
